...
<head>
  ...
  <style>
    ...
    .mission-form .form-select:focus {
      border-color: #4ade80;
...
<main class="org-main-content">
  <div class="container-fluid main-container">
    <div class="mission-form-page">
      <header class="mission-form-hero">
        <a href="/organization/dashboard" class="mission-form-back" aria-label="Back to dashboard">
          <i class="bi bi-arrow-left"></i>
        </a>
        <div class="mission-form-hero-text">
          <h1>Edit mission</h1>
          <p>Update your mission details below. Changes are saved immediately across your organization dashboard.</p>
        </div>
      </header>

      <form id="editMissionForm" class="mission-form">
        ...
        <div class="form-actions-bar">
          ...
          <button type="submit" class="btn btn-primary btn-save-mission">
